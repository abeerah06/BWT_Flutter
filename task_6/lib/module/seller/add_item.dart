...
class _AddItemScreenState extends State<AddItemScreen> {
  ...
  String _category = 'Clothes'; // Default category
  List<File> _images = [];
  ...
  List<Widget> _buildSizeInputs() {
    List<String> sizes = [];
    if (_category == 'Clothes' || _category == 'Jewellry') {
      sizes = ['XS', 'S', 'M', 'L', 'XL'];
              ...
              Card(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...['Clothes', 'Jewelry', 'Shoes'].map((category) {
                        return RadioListTile<String>(
                          title: Text(category, style: GoogleFonts.inter()),
                          value: category,

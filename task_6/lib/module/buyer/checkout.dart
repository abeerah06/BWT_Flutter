    ...
    return Scaffold(
      ...
      body: FutureBuilder<List<Map<String, dynamic>>>(
        ...
        builder: (context, snapshot) {
          ...
          double totalDeliveryCharges = storeGroupedItems.length * 250; //
              ...
              child: Column(
                ...
                children: [
                  ...
                  ...storeGroupedItems.entries.map((entry) {
                    ...
                    double storeDeliveryCharge = 250;

                    return Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text(
                          '${storeId}', // You may want to use a store name instead
                          style: GoogleFonts.inter(
                              fontSize: 20,
                              fontWeight: FontWeight.bold,
                              color: Color.fromRGBO(63, 26, 92, 1)),
                        ...
                        SizedBox(height: 8.0),
                        Text(
                          'Total Price: \PKR ${storeTotalPrice.toStringAsFixed(2)}',
                          style: GoogleFonts.inter(
                              fontSize: 16,
                              fontWeight: FontWeight.bold,
                              color: Color.fromRGBO(63, 26, 92, 1)),
                        ...
                        Text(
                          'Delivery Charges: \PKR ${storeDeliveryCharge.toStringAsFixed(2)}',
                          style: GoogleFonts.inter(
                              fontSize: 17,
                              color: Color.fromRGBO(63, 26, 92, 1)),
                        ),
                  ...
                  SizedBox(height: 20),
                  Text(
                    'Total Bill (including delivery charges): \PKR ${grandTotal.toStringAsFixed(2)}',
                    style: GoogleFonts.inter(
                        fontSize: 18,
                        fontWeight: FontWeight.bold,
                        color: Color.fromRGBO(63, 26, 92, 1)),
                  ...
                  Text(
                    ...
                    style: GoogleFonts.inter(
                        fontSize: 18, color: Color.fromRGBO(63, 26, 92, 1)),
                  ),
                  SizedBox(height: 20),
                  Form(
                    key: _formKey,
